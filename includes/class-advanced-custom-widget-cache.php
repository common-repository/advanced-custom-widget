...
/**
 * Add Widget Cache - cache widget.
 *
 * This utility generates caches for the widget
 *
 * @link      http://longvietweb.com
 * @since      1.0.0
 *
 * @package    Advanced_Custom_Widget
 * @subpackage Advanced_Custom_Widget_Cache/includes
 */
//initiate the class
add_action( 'plugins_loaded', 'acw_widget_cache_init' );
function acw_widget_cache_init() {
    $GLOBALS['Advanced_Custom_Widget_Cache'] = new Advanced_Custom_Widget_Cache();
}
class Advanced_Custom_Widget_Cache {
    /**
     * $cache_time
    ...
    function in_widget_form($t,$return,$instance){
        ...
        <p>
            ...
            <label for="<?php echo $t->get_field_id('wc_cache'); ?>"><?php _e('Disabled Cache On This Widget'); ?></label>
        </p>
        <?php
    }
